...
<meta name="keywords" content="about allaone store " />
...
<!-- about -->
		<div class="privacy about">
			<h3>About Us</h3>
			<p class="animi">Allaone compnay is number one compnay which is more reliable and friendly to our customers .will love to deal with you .customers are on first priority for us.we provide number one quality products and our customers are very happy with us .</p>
						...
						<div class="wmuSliderWrapper">
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="col-md-6 w3_testimonials_grid">
										<p></p>
										<h4>Phone: <span>+92 348 8700224</span></h4>
									</div>
									<div class="col-md-6 w3_testimonials_grid">
										<p></i></p>
										<h4>Fax <span>+92 52 6228806</span></h4>
									</div>
									<div class="clearfix"> </div>
								</div>
							</article>
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="col-md-6 w3_testimonials_grid">
										<p></i></p>
										<h4>Compnay Address:<span>aint Mary School Road,
Jamke 51310 Sialkot
Pakistan</span></h4>
									</div>
									<div class="col-md-6 w3_testimonials_grid">
										<p></i></p>
										<h4>Office Address: <span>Office address
...
Spain
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="col-md-6 w3_testimonials_grid">
										<p>.</p>
										<h4>Email: <span>mehmood@allaone.com</span></h4>
									</div>
									<div class="col-md-6 w3_testimonials_grid">
										
										<h4>Compnay Mail:<span>sale@allaone.com</span></h4>
									</div>
									<div class="clearfix"> </div>
								</div>
							</article>
